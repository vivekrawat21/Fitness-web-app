    ...
    <>
      {jsonData.map((data, index) => (
        <Box key={index} width={'60%'}>
          <Stack boxShadow={5} marginBottom={"90px"} border={"2px solid white"}>
            <img src={data.blogImage} style={{margin:"10px"}}alt='blog-img' />
            <div
              style={{
                display: 'flex',
            ...
            >
              <h1 style={{ borderBottom:'2px solid purple',margin:"12px 0" }}>
                {data.blogHeading}
              </h1>
